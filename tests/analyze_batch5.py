"""Анализ следующих 10 проблемных строк (41-50)."""
...
# Берем строки 41-50
test_cases = rows[41:51]

ege_generator = EGEAutoTitleGenerator()
python_generator = PythonAutoTitleGenerator()

print("Анализ следующих 10 проблемных строк (41-50):")
print("=" * 80)

for i, (row_num, channel, first_line, filename, old_title) in enumerate(test_cases, 41):
