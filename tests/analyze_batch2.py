"""Анализ следующих 10 проблемных строк (11-20)."""
...
# Берем строки 11-20 (индексы 11-20 в списке, пропуская заголовок)
test_cases = rows[11:21]

ege_generator = EGEAutoTitleGenerator()
python_generator = PythonAutoTitleGenerator()

print("Анализ следующих 10 проблемных строк (11-20):")
print("=" * 80)

for i, (row_num, channel, first_line, filename, old_title) in enumerate(test_cases, 11):
