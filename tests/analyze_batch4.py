"""Анализ следующих 10 проблемных строк (31-40)."""
...
# Берем строки 31-40
test_cases = rows[31:41]

ege_generator = EGEAutoTitleGenerator()
python_generator = PythonAutoTitleGenerator()

print("Анализ следующих 10 проблемных строк (31-40):")
print("=" * 80)

for i, (row_num, channel, first_line, filename, old_title) in enumerate(test_cases, 31):
