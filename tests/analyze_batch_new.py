"""Анализ первых 10 проблемных строк после обновления маппинга."""
...
print("Анализ первых 10 проблемных строк после обновления маппинга:")
print("=" * 80)
...
for i, (row_num, channel, first_line, filename, old_title) in enumerate(test_cases, 1):
    ...
    try:
        ...
        is_fixed = "Разбираем" in new_title or ("Курс" in new_title and filename_stem not in new_title)
